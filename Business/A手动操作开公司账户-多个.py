...
class CreatUser():
    def SaveApplyClient(self):
        ...
        data = {
            ...
            "idType": 13,
            #公司注册文书类型
            # "idNumber": idCardNo1,(可重复)
            "idNumber": 370101199102101985,
            # 公司注册编号
            "birthdayPlace": "FJI",
            # 成立国家
            "birthday": "2022-03-28",
